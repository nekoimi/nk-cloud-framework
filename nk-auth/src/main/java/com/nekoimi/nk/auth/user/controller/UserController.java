...
public class UserController {
    ...
    public Mono<JsonResp> updateFull(@PathVariable("id") String id, @ApiIgnore @RequestBody Map<String, Object> map) {
        return service.updateById(id, map).map(JsonResp::ok);
    }
    ...
    public Mono<JsonResp> updateBatch(@RequestParam("ids") String ids, @ApiIgnore @RequestBody Map<String, Object> map) {
        return service.updateBatch(ids, map).map(JsonResp::ok);
    }
