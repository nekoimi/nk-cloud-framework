package com.nekoimi.nk.framework.web.customizer;
...
import com.nekoimi.nk.framework.core.constant.DateTimeConstants;
...
public class HttpJackson2ObjectMapperBuilderCustomizer implements
    ...
    private void configureModules(Jackson2ObjectMapperBuilder builder) {
        Collection<Module> moduleBeans = getBeans(this.applicationContext, com.fasterxml.jackson.databind.Module.class);
