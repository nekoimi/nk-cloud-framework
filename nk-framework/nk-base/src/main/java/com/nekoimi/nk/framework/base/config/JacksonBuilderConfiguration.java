...
public class JacksonBuilderConfiguration {
    ...
    private static final TimeZone DEFAULT_DATE_TIME_ZONE = TimeZone.getTimeZone(ZoneId.of("Asia/Shanghai"));

//    @Bean
//    @ConditionalOnBean(ObjectMapper.class)
//    public CodecCustomizer jackson2JsonCodecCustomizer(ObjectMapper objectMapper) {
//        return (configurer) -> {
//            CodecConfigurer.DefaultCodecs defaults = configurer.defaultCodecs();
//            defaults.jackson2JsonDecoder(new Jackson2JsonDecoder(objectMapper, MimeTypeUtils.APPLICATION_JSON));
//            defaults.jackson2JsonEncoder(new Jackson2JsonEncoder(objectMapper, MimeTypeUtils.APPLICATION_JSON));
//        };
//    }
